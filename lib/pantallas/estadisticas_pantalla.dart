      ...
      setState(() {
        ...
        if (clienteTop is List && clienteTop.isNotEmpty) {
          clienteTopGasto = {
            ...
            'gasto_total': (clienteTop[0]['gasto_total'] as num?)?.toDouble() ?? 0,
          };
        }

        clientesPorCiudad = (ciudades as List<dynamic>?)
                ?.map((c) => {
                      'ciudad': c['ciudad'],
        ...
        ventasPorCategoria = (categorias as List<dynamic>?)
                ?.map((c) => {
        ...
        clientesPorSexo = (sexo as List<dynamic>?)
                ?.map((s) => {
                      'sexo': s['sexo'],
        ...
        child: GridView(
          ...
          children: [
            ...
            _dashboardCard(
              ...
              valueStyle: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white),
            ),
            ...
            _dashboardCard(
              ...
              value: productoMasVendido != null
                  ...
                  : "Sin datos",
              valueStyle: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white),
            ),
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text("VENTAS POR CATEGORÍA",
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: ventasPorCategoria.isNotEmpty
                                    ...
                                    PieChartData(
                                      ...
                                      sections: ventasPorCategoria.map((c) {
                                        final color = Colors.primaries[
                                            ventasPorCategoria.indexOf(c) % Colors.primaries.length];
                                ...
                                : const Center(child: Text("Sin datos", style: TextStyle(color: Colors.white))),
                          ),
                          // Leyenda
                          Expanded(
                            flex: 2,
                                ...
                                ? PieChart(
                                    PieChartData(
                                      ...
                                      sections: clientesPorSexo.map((s) {
                                        final color = Colors.primaries[
                                            clientesPorSexo.indexOf(s) % Colors.primaries.length];
                                        return PieChartSectionData(
                                          value: s['porcentaje'],
                                          title: "",
                                          radius: 50,
...
// ...existing code...
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    const Text("CLIENTES POR CIUDAD",
                        style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                    const SizedBox(height: 8),
                    Expanded(
                                    ...
                                    barRods: [
                                      BarChartRodData(
                                        ...
                                        color: Colors.primaries[
                                            clientesPorCiudad.indexOf(c) % Colors.primaries.length],
                                        width: 20,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(value, style: valueStyle ?? const TextStyle(color: Colors.white, fontSize: 20)),
            if (subtitle != null) ...[
              const SizedBox(height: 8),
